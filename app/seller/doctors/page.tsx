...
export default async function SellerDoctorsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Ümumi həkim siyahısı. Rəng təyin olunmuş satıcını göstərir; öz həkimlərinizi əlavə/redaktə edə bilərsiniz.</p>
      </div>
      <DoctorsManager doctors={rows} sellers={activeSellers} basePath="/seller/doctors" lockedSellerId={me} />
    </div>
  );
}
