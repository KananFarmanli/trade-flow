...
export default async function DirectorConsignmentPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Bütün satıcıların konsiqnasiya əməliyyatları, borclar və statuslar.</p>
      </div>
      <ConsignmentExplorer rows={rows} sellers={sellerOpts} />
    </div>
  );
}
