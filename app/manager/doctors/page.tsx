...
export default async function ManagerDoctorsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Həkimləri əlavə edin, redaktə edin və satıcılara təyin edin.</p>
      </div>
      <DoctorsManager doctors={rows} sellers={activeSellers} basePath="/manager/doctors" />
    </div>
  );
}
